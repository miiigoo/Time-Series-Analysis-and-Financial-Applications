...
def main():
    ...
    # Parameters
    hidden_layer_sizes = [10, 12, 15, 18, 20]  # Number of hidden neurons to test
    ...
    for hidden_nodes in hidden_layer_sizes:
        print(f"Training with {hidden_nodes} hidden nodes...")
        ...
        print(f"Hidden Nodes: {hidden_nodes}, Training Accuracy: {train_accuracy * 100:.2f}%, Test Accuracy: {test_accuracy * 100:.2f}%")

    # Plot results
    plt.figure(figsize=(10, 6))
    plt.plot(hidden_layer_sizes, train_accuracies, marker='o', label='Training Accuracy')
    plt.plot(hidden_layer_sizes, test_accuracies, marker='x', label='Test Accuracy')
